...
import com.example.minorproject2.Adapter.CartAdapter;
import com.example.minorproject2.Model.Product;
import com.example.minorproject2.R;
import com.example.minorproject2.databinding.ActivityCheckoutBinding;
...
public class CheckoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null && intent.hasExtra("userName") && intent.hasExtra("userEmail")) {
            ...
            // Set the retrieved values in the corresponding EditText fields
            binding.nameBox.setText(userName);
            binding.emailBox.setText(userEmail);
        }
